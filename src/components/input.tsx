...
export const Input = ({ ...props }: Props) => {
	return (
		<label className='flex gap-5 items-center w-full py-3 px-5 rounded-lg bg-dark-light border-2 border-dark-light focus-within:border-white-dimmed-heavy transition'>
